...
public class Environment extends JFrame implements ActionListener, KeyListener {
	...
	/**
	 * Updates the simulation mechanics by calling on the neural network
	 * and also updating the environment itself (the reproduction of food)
	 */
	public void update() {
		...
		for (int i = malishList.size() - 1; i >= 0; i--) 
		{
     		...
     		//wraps the screen from top to bottom and side to side, sets creature position if out of bounds of JFrame
